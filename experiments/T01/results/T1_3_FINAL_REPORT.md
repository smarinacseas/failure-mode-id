...
pass/fail`). Coverage prompts carry 6–7 heterogeneous, buried constraints
...
required_sections}; precision prompts carry 2–4 exactness-demanding constraints
...
30–70% base-model criterion-pass band — hard enough to leave repair headroom,
...
CI excludes 0 and the interaction is positive. Power context: ~3–4-point
