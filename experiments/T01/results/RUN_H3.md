...
- **Run:** 2026-07-20 20:18 to 20:22 UTC (~3m15s, all 6 arms + aggregate; single A100-80GB).
...
This is consistent with the mechanism: GRPO ran at a **tiny KL** (RA/RB KL ~0.006 to 0.016
...
- **Subset:** all 57 MMLU subjects (`cais/mmlu`, ungated); per-subject quota 17 to 18
