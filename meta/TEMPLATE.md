...
- **Prior**: *Smoke (n=1) showed 13 → 7 → 4 of 19. Expectation on full sample: same direction, but smaller magnitude, likely 9b ~10 to 15 pp ahead of 397b.*
...
- **Cost / wall-clock**: *~3 to 5× the v1 run on the candidate side (longer outputs), judge side unchanged. Ballpark $80 to $120 and ~8 to 12 hr.*
...
- **Cost / wall-clock**: *One full set of judge calls, ~$30 to $50 depending on alternate judge price, ~1.5 hr.*
